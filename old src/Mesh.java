...
public class Mesh {
	...
	public Mesh(float[] vertices, float[] textCoords, float[] normals, int[] indices) {
		this(vertices, textCoords, normals, indices, createEmptyIntArray(MAX_WEIGHTS * vertices.length / 3, 0), createEmptyFloatArray(MAX_WEIGHTS * vertices.length / 3, 0));
	}

	public Mesh(float[] vertices, float[] textCoords, float[] normals, int[] indices, int[] jointIndices, float[] weights) {

...
public class Build implements BuilderInterface {
	...
	public ArrayList<Vec3f> verticesG = new ArrayList<Vec3f>();
	public ArrayList<Vec2f> verticesT = new ArrayList<Vec2f>();
	public ArrayList<Vec3f> verticesN = new ArrayList<Vec3f>();

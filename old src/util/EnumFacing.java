package net.teamfps.savage.util;
...
public enum EnumFacing {
	...
	public static EnumFacing getFront(int index) {
		return VALUES[abs_int(index % VALUES.length)];
	}
	...
	public static EnumFacing getHorizontal(int p_176731_0_) {
		return HORIZONTALS[abs_int(p_176731_0_ % HORIZONTALS.length)];
	}
	...
	public static EnumFacing fromAngle(double angle) {
		return getHorizontal(floor_double(angle / 90.0D + 0.5D) & 3);
	}
